...
"<div class='wrap'>";
	...
	*/
	...
	function style_props_form(){
		...
		echo "<table border='1'><tr><th style='width:auto;'>Default</th><th>Style Name</th><th>Format</th><th style='width:auto;'>Author limit</th><th style='width:auto;'>Delete?</th></tr>";
		if($stylelist){
			sort($stylelist);
			foreach($stylelist as $name){
				...
				$checked = '';
				if(isset($this->formats['default_style']) && $this->formats['default_style'] == $name) $checked = 'checked';
				echo "<tr>
